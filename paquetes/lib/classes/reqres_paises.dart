...
//
//     final reqResPaises = reqResPaisesFromJson(jsonString);
...
ReqResPaises reqResPaisesFromJson(String str) => ReqResPaises.fromJson(json.decode(str));

String reqResPaisesToJson(ReqResPaises data) => json.encode(data.toJson());
...
class ReqResPaises {
    ...
    factory ReqResPaises.fromJson(Map<String, dynamic> json) => ReqResPaises(
        name: json["name"],
